export const ja = {
  ...
  settings: {
    ...
    projectCandidates: {
      ...
      matchMode: "一致モード",
      matchModeDesc: "複数の条件の組み合わせ方法",
      or: "いずれかに一致（OR）",
      and: "すべてに一致（AND）",
      prefixes: "ファイル名の接頭辞",
      prefixesDesc: "カンマ区切り。例: Project -",
      tags: "タグ",
      tagsDesc: "#なしでカンマ区切り。例: project",
      includeSubfolders: "サブフォルダも対象",
      limit: "候補の最大数",
      displayHeading: "表示ルール",
      trimPrefixes: "接頭辞を表示から隠す",
      transformName: "_ と - をスペースに変換",
      advanced: "高度な条件（任意）",
      nameRegex: "ファイル名の正規表現",
      excludePathRegex: "除外パスの正規表現",
      test: "候補をテスト",
      testDesc: "現時点で一致するノート数を表示します",
      testResult: "{count} 件（内容フィルタ前）",
    },
    taskFolder: {
      name: "タスクフォルダパス",
