...
interface FilePathFieldControllerOptions {
  text: TextLike
...
export class FilePathFieldController {
  ...
  constructor(options: FilePathFieldControllerOptions) {
